...
![vivid](https://repo.x-cmd.io/vivid.svg?lang=zh)
...
合计: **5,772** 行代码（覆盖前 5 种语言、共 **51** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Yaml | 4,675 | 128 | 1,368 | 38 |
| Rust | 793 | 8 | 126 | 9 |
| Json | 263 | 0 | 0 | 2 |
| Toml | 28 | 0 | 4 | 1 |
| Dockerfile | 13 | 0 | 4 | 1 |
...
- **上游仓库**: <https://github.com/sharkdp/vivid>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v0.11.1` (2026-04-09)
- **最近提交**: 2026-09-11
- **Release 含资产**: 19 个

## 流行度

- **Star**: 2,262 · **Fork**: 112 · **开放 issue**: 92 · **贡献者**: 54

## 累计统计

- **发布数**: 14 · **已合并 PR**: 118 · **开放 PR**: 10 · **已关闭 issue**: 71 · **开放 issue**: 21 · **提交数**: 376

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 0 | 9 | 1 | 0 | 1 | 10 |
| last60d | 2026-07-14 | 0 | 28 | 2 | 2 | 3 | 29 |
| 90d | 2026-06-14 | 0 | 28 | 2 | 2 | 3 | 29 |
| last180d | 2026-03-16 | 3 | 31 | 6 | 4 | 4 | 36 |
| 360d | 2025-09-17 | 3 | 42 | 9 | 7 | 5 | 48 |
| last720d | 2024-09-22 | 3 | 50 | 10 | 15 | 8 | 96 |
...
在 [repology.org](https://repology.org/project/vivid) 上共有 **34** 个发行版报告此项目。**17** 个 ✅ 已是最新上游版本，**14** 个 ⚠️ 使用旧版本。
...
vivid 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `vivid` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/vivid.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T05:34:25Z._
